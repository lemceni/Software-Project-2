...
class Gui(customtkinter.CTk):
    def __init__(self, dataBase=Db('ToDoListDb.db')):
        ...
        self.add_button = self.newButton(text='Add +',
                                ...
                                borderColor='#05A312',
                                bgColor='#a9c7c7')
        self.add_button.place(x=312,y=485)
        ...
        self.update_button.place(x=430,y=485)
        ...
        self.delete_button = self.newButton(text='Delete',
                                    ...
                                    borderColor='#E40404',
                                    bgColor='#a9c7c7')
        self.delete_button.place(x=568,y=485)
        ...
        self.export_button.place(x=693,y=485)
        ...
        self.import_button.place(x=820,y=485)

        self.import_button_json = self.newButton(text='Export JSON',onClickHandler=self.export_to_json, bgColor='#a9c7c7',fgColor='#066578', borderColor='#066578')
        self.import_button_json.place(x=950,y=485)
